    ...
    <>
      <div className="main_skill_body" id="skill">
        <div className="skill_image">
          <h1>Skills</h1>
          <img
            src="https://abhishek-rao-portfolio.herokuapp.com/_next/image?url=%2Fskill.svg&w=1200&q=75"
            alt="skillimage"
          />
        </div>
              ...
              <div className="language_logo">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path fill="#fafafa" d="M24 22.525H0l12-21.05 12 21.05z" />
                  </svg>
                </Avatar>
                <Avatar
                  className="materia-ui"
                  variant="rounded"
